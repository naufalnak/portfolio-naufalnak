...
export const projects = [
  ...
  {
    id: 8,
    slug: "job-tracker-files",
    year: "2026",
    title: "Job Tracker Files",
    desc: "A full-stack job application tracker built with Next.js 14 and Supabase. Features multi-user auth with row-level security, drag-and-drop kanban board, customizable statuses and interview stages, automated follow-up reminders, bulk actions, CSV export, and a metrics dashboard powered by Recharts to visualize job hunt progress.",
    tags: ["Next.js 14", "Supabase", "PostgreSQL", "Recharts", "Tailwind CSS"],
    type: "Full Stack",
    link: "https://job-tracker.naufalandr.my.id/",
    repo: "#",
    featured: false,
  ...
  },
  {
    ...
    desc: "Android mobile app for motherboard repair service management, the origin project that later evolved into BengkelHub as a full web platform. Built after 7-day user research and usability testing, with a clean UI implemented in Jetpack Compose.",
