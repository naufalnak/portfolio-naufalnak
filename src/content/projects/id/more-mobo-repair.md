...
- **IDE**: Android Studio
- **Design**: Figma (wireframe → prototype → handoff)

# Key Features

- Manajemen order servis (buat, update, tracking status)
- Data pelanggan dan riwayat servis
- UI yang clean dan intuitive untuk teknisi di lapangan
- Desain yang divalidasi melalui usability testing

# What I Learned

Project ini mengajarkan saya bahwa **research datang sebelum code**. Tujuh hari riset pengguna yang terasa "lama" itu justru menghemat banyak waktu revisi di fase development. Juga pengalaman pertama saya bekerja di tim cross-functional dengan desainer dan project manager.
